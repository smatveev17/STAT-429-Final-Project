...
The goal of the study is split into two parts, the goal of Analysis A is to investigate the relationship between greenhouse gas emissions and the average annual temperature in the United States from 1900 to 2023 while identifying the most influential factors affecting climate change over time. The goal of Analysis C is to investigate and confirm the underlying periodicity of Wolf sunspot solar cycle. In Analysis A we compared three models fit on exclusive social factors, exclusively emissions factors and a third model fit on both catergories of climate change factors to determine the strongest predictors of the average annual temperature. We found that the emissions model provided the best fit for the data and was able to forecast future values, capturing actual average annual temperatures within the 95% confidence intervals for 2023 and 2024. For Analysis C we used multiple spectral analysis tools, which included periodograms, wavelet analysis, and multitaper analysis, and were able to confirm that the most dominant period of the sunspot solar cycle is approximately 11 years, which is consistent with the past research. 
...
Magnetic activity of the Sun is an important topic in astronomy, both today and in the past, because it is a driving factor in solar flares and solar storms, knowing which is...
Now, 
...
For each time index $t$, let $P(\tau, t)$ denote the wavelet power at period $\tau$.\
